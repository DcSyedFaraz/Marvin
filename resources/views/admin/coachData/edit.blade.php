    ...
    <div class="container">
        ...
        <form action="{{ route('data.update', $conference->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="state" name="state" value="{{ $conference->state }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="added" name="added" value="{{ $conference->added }}">
            </div>
            <!-- Removed Field -->
            <div class="form-group">
                <label for="removed">Removed</label>
                <input type="text" class="form-control" id="removed" name="removed" value="{{ $conference->removed }}">
            </div>

            <!-- School Field -->
            <div class="form-group">
                <label for="school">School</label>
                <input type="text" class="form-control" id="school" name="school" value="{{ $conference->school }}">
            </div>
