...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('sport.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Sports</a>
    </div>
    <div class="card-body">
            ...
            @if($sports)
              @foreach($sports as $sports)   
                <tr>
                    ...
                    <td>
                        @if($sports->logo)
                            <img src="{{$sports->logo}}" class="img-fluid rounded-circle" style="max-width:50px" alt="{{$sports->photo}}">
                        @else
